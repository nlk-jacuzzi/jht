                ...
                <div class="twoCol extendedCol">
                        <div class="main">
                            <div class="hotub-mainimg">
                                ...
                                ?>
                                <?php echo ( isset($jht_specs['yt_video']) && !empty($jht_specs['yt_video']) ? do_shortcode('[video_lightbox_youtube video_id="'.$jht_specs['yt_video'].'&rel=false" width="640" height="480" anchor="'.get_template_directory_uri().'/images/icons/PlayBTN.png"]') : '' ); ?>
                            </div>
