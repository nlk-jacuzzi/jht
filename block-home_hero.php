...
<?php else : ?>
    ...
    */ ?>
    ...
    <div class="hero" style="background: url(<?php echo get_bloginfo('url'); ?>/wp-content/themes/jht/images/heros/Selector_Hero_V5.jpg) no-repeat 50% 50%;">
        <div id="hero-slide-1" class="block">
            <a href="<?php echo get_bloginfo('url'); ?>/hot-tub-wizard/" style="position: absolute; color: transparent; width: 192px; height: 40px; top: 240px; left: 10px;">See it in person</a>
        </div>
    </div>
