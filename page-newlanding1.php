<?php
/**
 * Template Name: NewLanding 1 (Avala)
 *
 * @package JHT
 * @subpackage JHT
 * @since JHT 1.0
                ...
                <table width="761">
                    <tr>
                        ...
                        <td width="271" style="vertical-align: middle">
                            <input type="button" value="Get My Brochure" class="bigGoldBtn taller" rel="ShowNext" />
                    ...
                    <div class="form-page-two" style="display: none;">
                        <div class="form-container-head">
                            ...
                            <img class="survey-no" src="<?php bloginfo('template_url'); ?>/images/icons/close.png" onClick="_gaq.push(['_trackEvent', 'lead', 'brochure-partial']);" />
                            <p class="page-two-header"><span>We appreciate your interest in Jacuzzi Hot Tubs!</span> To ensure we provide you the best possible information, would you please take a few more seconds to answer the following questions?</p>
                        </div>
                        ...
                        <div class="form-container-foot">
                            <span class="survey-yes"><input type="submit" value="Download Now" class="bigGoldBtn taller" onClick="_gaq.push(['_trackEvent', 'lead', 'brochure-full']);" /></span>
