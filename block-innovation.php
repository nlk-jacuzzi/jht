...
<div class="bbg-innovation">
	...
	<div class="innov-parts">
		...
		<div class="innov-sub-parts">
			...
			<a href="<?php echo get_bloginfo('url'); ?>/about/">Why Jacuzzi</a>
		</div>
		...
		<div class="innov-sub-parts">
			...
			<a href="<?php echo get_bloginfo('url'); ?>/hydrotherapy/">Why Hydrotherapy Works</a>
		</div>
		...
		<div class="innov-sub-parts">
			...
			<a href="<?php echo get_bloginfo('url'); ?>/warranty-options/">Warranty Options</a>
		</div>
