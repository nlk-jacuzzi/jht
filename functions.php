...
function jht_init() {
	...
	register_post_type( 'jht_coupon',
		array(
			...
			'show_in_menu' => true,
			//'menu_position' => 7,
			'menu_icon' => get_bloginfo('template_url') .'/images/icons/coupon_icon.png',
			'supports' => array('title','editor','thumbnail','page-attributes','revisions', 'custom-fields'),
			'rewrite' => array(
				'slug' => 'coupons',
				'with_front' => false
...
if ( jht_my_server() == 'dev' ) {
	...
	add_filter( 'gform_confirmation_24', 'custom_confirmation', 10, 4 );
}
	...
	if ( $the_query->have_posts() ) {
		...
		$confirmation = '<div class="wizard-page-title"><h2 class="wizard-results">Recommended hot tubs based on your selections:</h2></div>
			<div class="wizard-page-options">
				...
				<a class="reset" href="'.get_permalink().'">Start Over <span class="icon-reset"></span></a>
			</div>';
