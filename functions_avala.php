...
function avala_form_submit( $redirect = true ) {
	...
	if ( isset($_POST['EmailAddress']) && !empty($_POST['EmailAddress']) && (strpos( $_POST['EmailAddress'], '@' ) !== false) && empty($_POST['Address']) )
	{
		...
		$error_block = '<div id="avalaFormErrors">' . $err_str . '<pre style="display: none !important;"><code>';
...
function avala_hidden_fields( $leadSourceId = LEAD_SOURCE_ID, $leadCategoryId = LEAD_CATEGORY_ID, $leadTypeId = LEAD_TYPE_ID, $id = NULL, $campaignId = NULL ) {
	...
	echo '<input type="hidden" name="CountryCode" value="'. ( $geo['country'] ? $geo['country'] : 'US' ) .'" />';
...
function avala_json_array() {
    ...
    // Get Geo data
    //$geo = geo_data();
    $geo = geo_data_mysql_zip( $_POST['PostalCode'] );
    // Build the Array...
	$jsonArray	= array(
		...
		'WebSessionData'				=> array(
			...
			'PagesViewed'			=> ( ws_track('pages_viewed') ? ws_track('pages_viewed') : '' ),
			'PageViews'				=> ( ws_track('page_count') ? ws_track('page_count') : '' ),
			'PayoffLeft'			=> '',
			'TimeOnSite'			=> ( time_on_site() ? time_on_site() : '' ),
	...
	$args = array(
		...
		'product_id_list'		=> array(
			...
			'options'		=> array(
				...
				'J-LXL' => array( 'value' => '2', 'tub_id' => '159', 'title' => get_the_title(159), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 159, wp_get_attachment_url('three-quarter') ) ) ), // 'tub_id' is WP Post Id for tub
				'J-LX'  => array( 'value' => '1', 'tub_id' => '152', 'title' => get_the_title(152), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 152, wp_get_attachment_url('three-quarter') ) ) ),
				'J-495' => array( 'value' => '3', 'tub_id' => '4129', 'title' => get_the_title(4129), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 4129, wp_get_attachment_url('three-quarter') ) ) ),
				'J-480' => array( 'value' => '4', 'tub_id' => '3719', 'title' => get_the_title(3719), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3719, wp_get_attachment_url('three-quarter') ) ) ),
				'J-470' => array( 'value' => '5', 'tub_id' => '3724', 'title' => get_the_title(3724), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3724, wp_get_attachment_url('three-quarter') ) ) ),
				'J-465' => array( 'value' => '6', 'tub_id' => '3728', 'title' => get_the_title(3728), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3728, wp_get_attachment_url('three-quarter') ) ) ),
				'J-425' => array( 'value' => '7', 'tub_id' => '4143', 'title' => get_the_title(4143), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 4143, wp_get_attachment_url('three-quarter') ) ) ),
				'J-415' => array( 'value' => '8', 'tub_id' => '4517', 'title' => get_the_title(4517), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 4517, wp_get_attachment_url('three-quarter') ) ) ),
				'J-385' => array( 'value' => '21', 'tub_id' => '9691', 'title' => get_the_title(9691), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 9691, wp_get_attachment_url('three-quarter') ) ) ),
				'J-375' => array( 'value' => '9', 'tub_id' => '3737', 'title' => get_the_title(3737), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3737, wp_get_attachment_url('three-quarter') ) ) ),
				'J-365' => array( 'value' => '10', 'tub_id' => '3821', 'title' => get_the_title(3821), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3821, wp_get_attachment_url('three-quarter') ) ) ),
				'J-355' => array( 'value' => '11', 'tub_id' => '3827', 'title' => get_the_title(3827), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3827, wp_get_attachment_url('three-quarter') ) ) ),
				'J-345' => array( 'value' => '12', 'tub_id' => '3833', 'title' => get_the_title(3833), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3833, wp_get_attachment_url('three-quarter') ) ) ),
				'J-335' => array( 'value' => '13', 'tub_id' => '3840', 'title' => get_the_title(3840), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3840, wp_get_attachment_url('three-quarter') ) ) ),
				'J-325' => array( 'value' => '14', 'tub_id' => '3844', 'title' => get_the_title(3844), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3844, wp_get_attachment_url('three-quarter') ) ) ),
				'J-315' => array( 'value' => '15', 'tub_id' => '3839', 'title' => get_the_title(3839), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3839, wp_get_attachment_url('three-quarter') ) ) ),
				'J-280' => array( 'value' => '16', 'tub_id' => '3852', 'title' => get_the_title(3852), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3852, wp_get_attachment_url('three-quarter') ) ) ),
				'J-275' => array( 'value' => '17', 'tub_id' => '5316', 'title' => get_the_title(5316), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 5316, wp_get_attachment_url('three-quarter') ) ) ),
				'J-245' => array( 'value' => '18', 'tub_id' => '5320', 'title' => get_the_title(5320), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 5320, wp_get_attachment_url('three-quarter') ) ) ),
				'J-235' => array( 'value' => '19', 'tub_id' => '5307', 'title' => get_the_title(5307), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 5307, wp_get_attachment_url('three-quarter') ) ) ),
				'J-210' => array( 'value' => '20', 'tub_id' => '3864', 'title' => get_the_title(3864), 'img' => wp_get_attachment_url(MultiPostThumbnails::get_post_thumbnail_id('jht_tub', 'three-quarter', 3864, wp_get_attachment_url('three-quarter') ) ) ),
					),
			'default_value'	=> '',
			),
		'newsletter'			=> array(
...
function avala_field( $avala_field, $additional_classes = NULL, $is_required = false, $show = NULL, $appended = NULL, $input_type = false, $text = false, $select_default = false ) {
	...
	if ( $input_type == 'select' )
	{
		...
		foreach ( $field['options'] as $k => $v )
		{
			...
			if ( ( isset( $_POST[$field['name']] ) && $v['value'] == $_POST[$field['name']] ) || ( $field['default_value'] && $v['value'] == $field['default_value'] ) )
			{
				$str_field .= 'selected="selected" ';
			}
			else if ( !empty($_GET['tid']) && $_GET['tid'] === $v['tub_id'] ) {
				$str_field .= 'selected="selected" ';
			}
			else {}
			$str_field .= '>' . $k . '</option>';
