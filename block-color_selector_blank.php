...
.color-selector.color-selector-container .color-selector-wrapper .right .pdf-download { color: #414141; font: 600 14px/14px "GSL"; text-transform: capitalize;  letter-spacing: 0px !important;}
	...
	<div class="color-selector-wrapper">
		...
		<div class="left">
			...
			<div class="tub-container">
				<div class="tub-skirt">
					<img class="active" src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/skirts/skirt-brazilianteak.png" timg="brazilianteak" height="410" width="576" />
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/skirts/skirt-roastedchestnut.png" timg="roastedchestnut" height="410" width="576" />
				...
				<div class="tub-shell">
					<img class="active" src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/platinum.png" timg="platinum" height="410" width="576" />
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/silverpearl.png" timg="silverpearl" height="410" width="576" />
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/monaco.png" timg="monaco" height="410" width="576" />
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/midnight.png" timg="midnight" height="410" width="576" />
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/opal.png" timg="opal" height="410" width="576" />
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/sahara.png" timg="sahara" height="410" width="576" />
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/sand.png" timg="sand" height="410" width="576" />
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/desertsand.png" timg="desertsand" height="410" width="576" />
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/caribbeansurf.png" timg="caribbeansurf" height="410" width="576" />
		...
		<div class="right">
			...
			<div class="shells">
				<div class="shell thumb active" timg="platinum" data-pdf="platinum" rel="Platinum" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/acrylic-thumb-platinum.png" height="45" width="45"/></div>
				<div class="shell thumb" timg="silverpearl" data-pdf="silverpearl" rel="Silver Pearl" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/acrylic-thumb-silverpearl.png" height="45" width="45" /></div>
				<div class="shell thumb" timg="monaco" data-pdf="monaco" rel="Monaco" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/acrylic-thumb-monaco.png" height="45" width="45" /></div>
				<div class="shell thumb" timg="midnight" data-pdf="midnight" rel="Midnight" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/acrylic-thumb-midnight.png" height="45" width="45" /></div>
				<div class="shell thumb" timg="opal" data-pdf="opal" rel="Opal" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/acrylic-thumb-opal.png" height="45" width="45" /></div>
				<div class="shell thumb" timg="sahara" data-pdf="sahara" rel="Sahara" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/acrylic-thumb-sahara.png" height="45" width="45" /></div>
				<div class="shell thumb" timg="sand" data-pdf="sand" rel="Sand" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/acrylic-thumb-sand.png" height="45" width="45" /></div>
				<div class="shell thumb" timg="desertsand" data-pdf="desertsand" rel="Desert Sand" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/acrylic-thumb-desertsand.png" height="45" width="45" /></div>
				<div class="shell thumb" timg="caribbeansurf" data-pdf="caribbeansurf" rel="Caribbean Surf" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/shells/acrylic-thumb-caribbeansurf.png" height="45" width="45" /></div>
			...
			<div class="skirts">
				<div class="skirt thumb brazilianteak active" timg="brazilianteak" rel="Brazilian Teak" data-pdf="teak" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/skirts/skirt-thumb-brazilianteak.png" height="45" width="45" /></div>
				<div class="skirt thumb roastedchestnut" timg="roastedchestnut" rel="Roasted Chestnut" data-pdf="chest" ><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/lowres-colorselector/skirts/skirt-thumb-roastedchestnut.png" height="45" width="45" /></div>
